...
function loadList() {
    ...
    data.forEach(item => {
        // Create a card for each person/innovation
        const card = document.createElement('div');
        card.className = 'card';
        card.onclick = () => showDetail(item.id); // Add click event
...
function showDetail(id) {
    ...
    // Populate the detail view with data
...
// Function to switch back to home view
function showHome() {
